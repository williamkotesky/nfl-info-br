...
function Time() {
    ...
    function editPost(team) {
        if((team.conference.id === '1' && team.division.id[0] === '2') || (team.conference.id === '2' && team.division.id[0] === '1')) {
            ...
            {team.name ? (
                <section className={styles.timeContainer}>
                    ...
                    <div className={styles.timeBtns}>
                        <button className={styles.actionBtn} onClick={toggleTeamsForm}>{!showTeamsForm ? 'Info' : 'Editar' }</button>
                    ...
                    {showTeamsForm ? (
                        ...
                        <TeamsForm handleSubmit={editPost} 
